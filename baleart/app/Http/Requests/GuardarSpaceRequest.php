...
class GuardarSpaceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'name' => 'required|unique:spaces|min:5|max:100',
            'regNumber' => 'required|unique:spaces|min:5|max:10',
    ...
    public function messages() {
        return [
            ...
            'name.unique' => 'El espacio ya existe, no se puede duplicar',
            'name.min' => 'Nombre mínimo son 5 caracteres',
            'name.max' => 'Nombre máximo son 100 caracteres',
            'regNumber.required' => 'El número de registro debe estar informado',
            'regNumber.unique' => 'El número de registro ya existe, no se puede duplicar',
