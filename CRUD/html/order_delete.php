				...
				<div class="col-md-10 table-responsive">
					...
					try {
                        ...
                        if(array_key_exists('delete',$_POST)){ //Si se pulsa el botón de delete se ejecuta
                            $order->destroy();
                            header("Location: orders.php"); //Redirige a la lista de Orders y OrderItems de dichos Orders.
                        }
                    ...
                    <form method="post" class="mb-3">
                        <div class="d-grid gap-2">
                        	<button type="submit" name="delete" class="btn btn-danger btn-lg" value="delete">Are you sure you want to delete this order?</button>
                        </div>
                    </form>
				</div>
			</div>
